...
public interface TasksApi {
    ...
    ResponseEntity<BalanceTestResult> tasksValidateBracketsGet( @NotNull @Size(min=1,max=100)@ApiParam(value = "Input string (max length 100)", required = true) @RequestParam(value = "input", required = true) String input);
